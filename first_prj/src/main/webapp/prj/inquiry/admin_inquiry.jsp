...
<%@page import="kr.co.sist.inquiry.InquiryUtil"%>
<%@page import="kr.co.sist.inquiry.InquirySearchVO"%>
<%@page import="kr.co.sist.inquiry.AdminInquiryDAO"%>
...
<jsp:useBean id="sVO" class="kr.co.sist.inquiry.InquirySearchVO" scope="page"/>
