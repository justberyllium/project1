<%@page import="kr.co.sist.review.ReviewUtil"%>
<%@page import="java.sql.SQLException"%>
<%@page import="java.util.List"%>
<%@page import="kr.co.sist.review.ReviewVO"%>
<%@page import="kr.co.sist.review.AdminReviewDAO"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <jsp:useBean id="sVO" class="kr.co.sist.review.ReviewSearchVO"/>
 ...
 <!-- 헤더와 사이드바 임포트-->
   ...
   <tr> <td colspan="5" style="text-align: center;"> <strong>해당 조건에 맞는 검색 결과가 없습니다</strong>  </td></tr>
      ...
      <tr>
	      ...
	      <td>작성자ID</td>
	      <td>등록일</td>
	      <td>평점  <img src="http://192.168.10.225/first_prj/prj/images/img7.png"></td>
      </tr>
      </thead>
      <tbody>
